...
public class GameUtil {
     ...
     * 装载图片的方法
     *
     * @param assetPath 图片路径
     * @return 图片资源
     */
    public static BufferedImage loadBufferedImage(String assetPath) {
        try {
            InputStream inputStream = GameUtil.class.getResourceAsStream(assetPath);
